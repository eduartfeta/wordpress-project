		...
		trx_addons_apply_filters( 'trx_addons_gb_map', {
			...
			edit: function(props) {
				...
				if ( ! TRX_ADDONS_STORAGE['gutenberg_sc_params']['taxonomies'][post_type_1].hasOwnProperty( taxonomy_1 ) ) {
					taxonomy_1 = trx_addons_array_first_key( TRX_ADDONS_STORAGE['gutenberg_sc_params']['taxonomies'][post_type_1] );
				}
				...
				if ( ! TRX_ADDONS_STORAGE['gutenberg_sc_params']['taxonomies'][post_type_2].hasOwnProperty( taxonomy_2 ) ) {
					taxonomy_2 = trx_addons_array_first_key( TRX_ADDONS_STORAGE['gutenberg_sc_params']['taxonomies'][post_type_2] );
				}
				...
				if ( ! TRX_ADDONS_STORAGE['gutenberg_sc_params']['taxonomies'][post_type_3].hasOwnProperty( taxonomy_3 ) ) {
					taxonomy_3 = trx_addons_array_first_key( TRX_ADDONS_STORAGE['gutenberg_sc_params']['taxonomies'][post_type_3] );
				}
