		...
		$schemes = array(
			...
			'default' => array(
				...
				'colors'   => array(
					...
					'bg_color'         => '#F5F5F5', //ok PH
					'bd_color'         => '#DDDEE0', //ok PH

					// Text and links colors
					'text'             => '#797C7F', //ok PH
					'text_light'       => '#A5A6AA', //ok
					'text_dark'        => '#1F1E1E', //ok PH
					'text_link'        => '#F6AB2A', //ok
					'text_hover'       => '#E99E1C', //ok
					'text_link2'       => '#A872EE', //ok
					'text_hover2'      => '#925CD8', //ok
					'text_link3'       => '#899BC2', //ok
					'text_hover3'      => '#7687AC', //ok

					// Alternative blocks (sidebar, tabs, alternative blocks, etc.)
					'alter_bg_color'   => '#ffffff', //ok
					'alter_bg_hover'   => '#E3E4E5', //ok PH
					'alter_bd_color'   => '#DDDEE0', //ok PH
					'alter_bd_hover'   => '#E8E8E9', //ok PH
					'alter_text'       => '#797C7F', //ok
					'alter_light'      => '#A5A6AA', //ok
					'alter_dark'       => '#1F1E1E', //ok PH
					'alter_link'       => '#F6AB2A', //ok
					'alter_hover'      => '#E99E1C', //ok
					'alter_link2'      => '#A872EE', //ok
					'alter_hover2'     => '#925CD8', //ok
					'alter_link3'      => '#899BC2', //ok
					'alter_hover3'     => '#7687AC', //ok

					// Extra blocks (submenu, tabs, color blocks, etc.)
					'extra_bg_color'   => '#181717', //ok PH
					...
					'input_bd_color'   => '#DDDEE0', //ok PH
					'input_bd_hover'   => '#1F1E1E', //ok PH
					'input_text'       => '#A5A6AA', //ok
					'input_light'      => '#A5A6AA', //ok
					'input_dark'       => '#1F1E1E', //ok PH
			...
			'dark'    => array(
				...
				'colors'   => array(
					...
					// Whole block border and background
					'bg_color'         => '#0C0B0B', //ok PH
					'bd_color'         => '#302F2F', //ok PH

					// Text and links colors
					'text'             => '#D2D3D5', //ok PH
					'text_light'       => '#A2A2A2', //ok PH
					'text_dark'        => '#F5F5F5', //ok PH
					'text_link'        => '#F6AB2A', //ok
					'text_hover'       => '#E99E1C', //ok
					'text_link2'       => '#A872EE', //ok
					'text_hover2'      => '#925CD8', //ok
					...
					// Alternative blocks (sidebar, tabs, alternative blocks, etc.)
					'alter_bg_color'   => '#181717', //ok PH
					'alter_bg_hover'   => '#0C0B0B', //ok PH
					'alter_bd_color'   => '#302F2F', //ok PH
					'alter_bd_hover'   => '#3D3C3C', //ok PH
					'alter_text'       => '#D2D3D5', //ok PH
					'alter_light'      => '#A2A2A2', //ok PH
					'alter_dark'       => '#F5F5F5', //ok PH
					'alter_link'       => '#F6AB2A', //ok
					'alter_hover'      => '#E99E1C', //ok
					'alter_link2'      => '#A872EE', //ok
					'alter_hover2'     => '#925CD8', //ok
					...
					// Extra blocks (submenu, tabs, color blocks, etc.)
					'extra_bg_color'   => '#1F1E1E',// PH
					'extra_bg_hover'   => '#3f3d47',
					'extra_bd_color'   => '#313131',
					'extra_bd_hover'   => '#575757',
					'extra_text'       => '#A2A2A2',// PH
					'extra_light'      => '#afafaf',
					'extra_dark'       => '#ffffff',
					'extra_link'       => '#F6AB2A',
					'extra_hover'      => '#ffffff',
					...
					'input_bg_color'   => '#transparent', //ok
					'input_bg_hover'   => '#transparent', //ok
					'input_bd_color'   => '#302F2F', //ok -PH
					'input_bd_hover'   => '#302F2F', //ok - PH
					...
					'inverse_text'     => '#F5F5F5', //ok PH
					'inverse_light'    => '#6f6f6f',
					'inverse_dark'     => '#1F1E1E', //ok PH
					'inverse_link'     => '#ffffff', //ok
					'inverse_hover'    => '#1F1E1E', //ok PH
